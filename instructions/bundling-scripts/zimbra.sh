...
CreateRhelPackage()
{
  ...
  zimbra=( base perl perl-base apache-components dnscache-components ldap-components mta-components os-requirements proxy-components spell-base spell-components  )
